...
class DmConversations extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  DmConversations(this.attachedDatabase, [this._alias]);
  ...
  @override
  DmConversations createAlias(String alias) {
    return DmConversations(attachedDatabase, alias);
  }
...
class DmMessages extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  DmMessages(this.attachedDatabase, [this._alias]);
  ...
  late final GeneratedColumn<int> isOutgoing = GeneratedColumn<int>(
    'is_outgoing',
    aliasedName,
    false,
    type: DriftSqlType.int,
  ...
  @override
  DmMessages createAlias(String alias) {
    return DmMessages(attachedDatabase, alias);
  }
...
class DatabaseAtV4 extends GeneratedDatabase {
  ...
  late final DmConversations dmConversations = DmConversations(this);
  late final DmMessages dmMessages = DmMessages(this);
  @override
