  ...
  group('VideoStats', () {
    group('fromJson', () {
      test('parses id and pubkey from byte arrays', () {
        ...
        final json = {
          'id': [
            49, 52, 55, 102, 100, 55, 48, 101, 48, 57, 49, 97, 101, 101,
            51, 49, 55, 51, 55, 50, 49, 52, 99, 54, 54, 99, 56, 50, 54,
            100, 57, 55, 48, 50, 53, 101, 101, 49, 102, 102, 102, 48,
            52, 49, 52, 49, 98, 54, 57, 98, 97, 48, 57, 56, 55, 97, 53,
            98, 99, 102, 99, 52, 54, 98,
          ],
          'pubkey': [
            57, 99, 102, 97, 55, 100, 53, 55, 48, 97, 102, 53, 100, 100,
            101, 49, 100, 55, 57, 98, 52, 55, 54, 97, 99, 50, 99, 56, 98,
            53, 52, 51, 98, 49, 57, 55, 48, 48, 54, 53, 100, 53, 52, 56,
            56, 102, 52, 100, 56, 54, 102, 97, 102, 51, 99, 51, 52, 99,
            49, 54, 55, 101, 51, 49,
          ],
          'created_at': 1767316187,
          'kind': 34236,
          'd_tag': '8bdf98cee2ae5de03d5e7a8e5fbe9ba0a7b5bf4c51ecd2d10acdc66fd8511425',
          'title': 'Test Video',
      ...
      test('parses id and pubkey from strings', () {
        ...
        final json = {
          'id': '147fd70e091aee31737214c66c826d97025ee1fff04141b69ba0987a5bcfc46b',
          'pubkey': '9cfa7d570af5dde1d79b476ac2c8b543b1970065d5488f4d86faf3c34c167e31',
          'created_at': 1767316187,
          'kind': 34236,
          'd_tag': 'test-dtag',
