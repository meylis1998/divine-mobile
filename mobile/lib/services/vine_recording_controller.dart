...
class MacOSCameraInterface extends CameraPlatformInterface
  ...
  @override
  bool get isReady => isInitialized; // From AsyncInitialization mixin
...
class WebCameraInterface extends CameraPlatformInterface {
  ...
  @override
  bool get isReady => _webCameraService != null && _previewWidget != null;
...
class VineRecordingController {
  ...
  bool get canRecord =>
      (_cameraInterface?.isReady ?? false) &&
    ...
    try {
      ...
      if (kIsWeb) {
        ...
        if (Platform.isIOS) {
          ...
          _cameraInterface!.onStateChanged = () => _onStateChanged?.call();
